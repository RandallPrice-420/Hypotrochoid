...
{
    public partial class RPSciFiForm_Dashboard : Form, IRPSciFiControl
    {
        // ---------------------------------------------------------------------
        // Private Variables:
        // ------------------
        ...
        private RPSciFiForm_Bridge    _formBridge;
        ...
        public string ControlId => throw new NotImplementedException();

        public RPSciFiControlType ControlType => throw new NotImplementedException();
        ...
        // ----------------------
        //   RPSciFiForm_Dashboard()
        // ---------------------------------------------------------------------

        #region .  RPSciFiForm_Dashboard()  .
        // ---------------------------------------------------------------------
        //   Method.......:  RPSciFiForm_Dashboard()
        //   Description..:  The constructor for the RPSciFiForm_Dashboard class.
        //   Parameters...:  None
        //   Returns......:  Nothing
        // ---------------------------------------------------------------------
        public RPSciFiForm_Dashboard()
        {
        ...
        #region .  BuildHudTimer()  .
        // ---------------------------------------------------------------------
        //   Method.......:  BuildHudTimer()
        //   Description..:  
        //   Parameters...:  None
        //   Returns......:  Nothing
        // ---------------------------------------------------------------------
        ...
        private void BuildLayout()
        {
            ...
            _btnWarp = new RPSciFiButton()
            {
                ...
                ShowDistortionEffect = false,
                TextColorDisabled    = Color.DarkGray,     // Color.FromArgb(100, Color.Cyan),
                TextColorEnabled     = Color.SpringGreen,
                TextColorPressed     = Color.Red,
            };
            _btnWarp.Click += (s, e) =>
            {
            ...
            _btnImpulse = new RPSciFiButton()
            {
                ...
                Size              = new Size(150, 50),
                TextColorDisabled = Color.FromArgb(100, Color.Cyan),
                TextColorEnabled  = Color.Cyan,
                TextColorPressed  = Color.Red,
            };
            ...
            {
                if (!IsFormOpen<RPSciFiForm_Bridge>())
                {
                    // Open the form.
                    _formBridge = new RPSciFiForm_Bridge();
                    _formBridge.Show();
                }
                else
                {
                    // Optionally bring the existing form to front
                    RPSciFiForm_Bridge formBridge = Application.OpenForms.OfType<RPSciFiForm_Bridge>().FirstOrDefault();
                    if (formBridge != null)
                    {
                        formBridge.BringToFront();
                    }
                }
            };
        ...
        #region .  DrawHudOverlay()  .
        // ---------------------------------------------------------------------
        //   Method.......:  DrawHudOverlay()
        //   Description..:  
        //   Parameters...:  None
        //   Returns......:  Nothing
        // ---------------------------------------------------------------------
